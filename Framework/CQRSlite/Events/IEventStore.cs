...
namespace CQRSlite.Events
{
    ...
    public interface IEventStore
    {
        ...
        Task<IEnumerable<IEvent>> Get(Guid aggregateId, int fromVersion = -1, DateTimeOffset? toDate = null, CancellationToken cancellationToken = default(CancellationToken));
